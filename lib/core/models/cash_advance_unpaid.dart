...
class UnpaidCashAdvanceData {
  ...
  // Statis Method
  factory UnpaidCashAdvanceData.fromJson(Map<String, dynamic> json) {
    return UnpaidCashAdvanceData(
      id: json["id"],
      userId: json["user_id"],
      title: json["title"],
...
// Fetch data from API
Future<List<UnpaidCashAdvanceData>> fetchUnpaidCashAdvance() async {
  ...
  try {
    ...
    if (result.statusCode == 200) {
      ...
      final listOfCashAdvance = await pcs.map<UnpaidCashAdvanceData>((json) {
        return UnpaidCashAdvanceData.fromJson(json);
      }).toList();
