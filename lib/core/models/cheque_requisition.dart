...
class ChequeRequisitionData {
  ...
  // Statis Method
  factory ChequeRequisitionData.fromJson(Map<String, dynamic> json) {
    return ChequeRequisitionData(
      id: json["id"],
      userId: json['user_id'],
      payee: json['payee'],
      amount: json['amount'],
...
// Fetch data from API
Future<List<ChequeRequisitionData>> fetchChequeRequisition() async {
  ...
  try {
    ...
    if (result.statusCode == 200) {
      ...
      final listOfChequeRequisition = await pcs.map<ChequeRequisitionData>((json) {
        return ChequeRequisitionData.fromJson(json);
      }).toList();
