...
class ChequeRequisitionHodData {
  int id;
  int userId;
  String payee;
  int amount;
  ...
  // Statis Method
  factory ChequeRequisitionHodData.fromJson(Map<String, dynamic> json) {
    return ChequeRequisitionHodData(
      id: json["id"],
      userId: json['user_id'],
      payee: json['payee'],
      amount: json['amount'],
...
// Fetch data from API
Future<List<ChequeRequisitionHodData>> fetchChequeRequisitionHodData() async {
  ...
  try {
    ...
    if (result.statusCode == 200) {
      ...
      final listOfChequeRequisition = await pcs.map<ChequeRequisitionHodData>((json) {
        return ChequeRequisitionHodData.fromJson(json);
      }).toList();
