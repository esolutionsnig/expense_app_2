...
class UnpaidPettyCashData {
  ...
  // Statis Method
  factory UnpaidPettyCashData.fromJson(Map<String, dynamic> json) {
    return UnpaidPettyCashData(
...
// Fetch data from API
Future<List<UnpaidPettyCashData>> fetchUnpaidPettyCash() async {
  var listOfPettyCash;
  ...
  try {
    ...
    if (result.statusCode == 200) {
      ...
      final listOfPettyCash = await pcs.map<UnpaidPettyCashData>((json) {
        return UnpaidPettyCashData.fromJson(json);
      }).toList();
